...
%~~~~~~~~~~~~~  1.0. front matter  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  \samtitle{rec 08: inventing rnns}

  \noindent
    Today we'll encounter general design themes in deep learning by `inventing'
    RNNS.
    \marginnote{%
    Our rough schedule is:
    \begin{description}
        \item[\hspace{0.25cm}] \emph{19:30} `to build a tool, use it' 
        \item[\hspace{0.25cm}] \emph{19:45} locality 
        \item[\hspace{0.25cm}] \emph{20:00} symmetry
        \item[\hspace{0.25cm}] \emph{20:15} cnns: `derivation'
        \item[\hspace{0.25cm}] \emph{20:30} rnns: `derivation' 
        \item[\hspace{0.25cm}] \emph{20:45} gating in rnns  
    ...
    \samsubsection{meeting the data}

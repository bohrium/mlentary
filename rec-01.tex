    ...
    \samsubsection{python basics}
      ...
      \samsubsubsection{state and assignment}
        ...
        one-letter name or a longer name:\bcirc\marginnote{%
          ...
          %
          Moreover, the following names are forbidden, since they already mean
          something else in Python: \texttt{if}, \texttt{elif}, \texttt{else},
          \texttt{for}, \texttt{while}, \texttt{break}, \texttt{continue},
          \texttt{try}, \texttt{except};
          %
          \texttt{import}, \texttt{with}, \texttt{def}, \texttt{assert};
          %
          \texttt{bool}, \texttt{int}, \texttt{float}, \texttt{str},
          \texttt{set}, \texttt{dict}, \texttt{list};
          %
          \texttt{round}, \texttt{chr}, \texttt{ord}, \texttt{enumerate},
          \texttt{type}, \texttt{range}, \texttt{print}, \texttt{input}.
          \texttt{zip} \texttt{sum}, \texttt{max}, \texttt{min}, \texttt{len},
          %
      ...
      \samsubsubsection{data in aggregate}%container structures}
        \attn{lists, strings, numpy arrays} % no tuples

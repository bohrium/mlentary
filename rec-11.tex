...
\begin{document}
  \samtitle{recitation 11}
      
  \samsection{reinforcement}
    \samsubsection{bird's eye view}
      \samsubsubsection{kinds of learning}
        ...
        sources.  We've so far focused on the most important case: learning from
        examples.  
        Learning by example is key to
          the other modes of learning.
        Today we'll discuss learning by reinforcement.

        Motivating real-world examples include robotics, poker, and ad
        placement.
  ...
  \samsection{bandits}
    ...
    \samsubsection{unconditional}
      ...
      $\sfr$ takes values in $\{0,1\}$.  Thus, the world is determined by 
      a probability $p_a$ of nonzero reward for each action $a$.
